...
| p/        | `add-i-role`                   | Pay of the internship role (optional parameter)                                    | Only numbers with up to one decimal point allowed. Must be a non-negative number. Display will be formatted to 2 decimal places. | 1000, 1000.00, 1000.000000 (will be shown as 1000.00) | $1000, -1, -0      |
